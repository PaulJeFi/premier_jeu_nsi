...
zombie_wave_spawn_rate = {0: [["Z1"]*100, [200, 400], 0],
                        ...
                        4: [["Z1"]*60 + ["Z2"]*35 + ["Z3"]*5, [100, 330], 1.5],
                        5: [["Z1"]*35 + ["Z2"]*45 + ["Z3"]*15 + ["ZD"]*5, [70, 300], 2],
                        6: [["Z1"]*20 + ["Z2"]*45 + ["Z3"]*25 + ["ZD"]*10, [40, 275], 2.5],
                        7: [["Z1"]*10 + ["Z2"]*35 + ["Z3"]*40 + ["ZD"]*15, [10, 250], 3],
                        8: [["Z1"]*5 + ["Z2"]*25 + ["Z3"]*50 + ["ZD"]*20, [0, 225], 4],
                        9: [["Z2"]*15 + ["Z3"]*60 + ["ZD"]*25, [0, 200], 5],
                        10: [["Z2"]*5 + ["Z3"]*65 + ["ZD"]*30, [0, 175], 6.5],
                        11: [["Z3"]*65 + ["ZD"]*35, [0, 150], 8],
