...
zombie_wave_spawn_rate = {0: [["Z1"]*100, [200, 400], 0],
                        ...
                        6: [["Z1"]*34 + ["Z2"]*45 + ["Z3"]*16 + ["ZD"]*5, [50, 275], 2.5],
                        7: [["Z1"]*22 + ["Z2"]*45 + ["Z3"]*24 + ["ZD"]*9, [50, 250], 3],
                        8: [["Z1"]*10 + ["Z2"]*40 + ["Z3"]*36 + ["ZD"]*14, [50, 225], 4],
                        9: [["Z2"]*31 + ["Z3"]*50 + ["ZD"]*19, [50, 200], 5],
                        10: [["Z2"]*15 + ["Z3"]*60 + ["ZD"]*25, [50, 175], 6.5],
                        11: [["Z3"]*68 + ["ZD"]*32, [50, 150], 8],
                        12: [["Z3"]*60 + ["ZD"]*40, [50, 100], 10],
